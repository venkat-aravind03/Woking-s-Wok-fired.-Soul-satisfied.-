...
export default async function MenuPage() {
  ...
  return (
    <>
      {/* Menu Page Hero Strip */}
      <section className="h-[280px] max-md:h-[200px] relative flex flex-col items-center justify-center text-center px-6 md:px-16 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-charcoal/[0.85] to-charcoal/70 z-10" />
        <div className="relative z-20 flex flex-col items-center">
          ...
          <p className="font-[family-name:var(--font-body)] text-lg max-md:text-[15px] text-white/80 mb-5 max-w-lg">
            Fresh. Wok-fired. Delivered fast. 🍜
          </p>
          <div className="bg-primary text-white font-[family-name:var(--font-body)] text-[12px] font-bold uppercase tracking-wider px-4 py-1.5 rounded-full">
            Available on Zomato &amp; Swiggy
          </div>
        </div>
      </section>

      <MenuClientContent categories={categories} allItems={items} />
    </>
  );
}
